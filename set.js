...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~X3B2nBYK#6vkWPIJWpaqbV2n-9ek8OfTxSDJRdiSWS-apNGz9qtc", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
MODE: process.env.MODE || "privatr", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349134673563", // Only 1 owner Number Here, others Add to sudo numbers...
